...
<Alert
  title="Careful"
  message="This guide WILL OVERWRITE your hardware, be sure you are setting up on the Homelab server, not your Personal Computer. See the diagram if you are confused."
/>
...
When you're booting into the Ubuntu Server installer, you can follow my screen record here.
    ...
    <div className="video-wrapper">
      <iframe
        width="560"
        height="315"
        src="https://www.youtube.com/embed/exrSQfpAIS8?si=a52RSYI3uNF0SiQ7&vq=hd720"
